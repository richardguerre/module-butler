...
module-butler/1.0.2 darwin-x64 node-v14.17.1
...
_See code: [src/commands/generate.ts](https://github.com/richardguerre/module-butler/blob/v1.0.2/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/richardguerre/module-butler/blob/v1.0.2/src/commands/init.ts)_
<!-- commandsstop -->
