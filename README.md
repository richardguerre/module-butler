...
_See code: [src/commands/generate.ts](https://github.com/richardguerre/module-butler/blob/v1.0.3/src/commands/generate.ts)_
...
_See code: [src/commands/init.ts](https://github.com/richardguerre/module-butler/blob/v1.0.3/src/commands/init.ts)_
<!-- commandsstop -->
